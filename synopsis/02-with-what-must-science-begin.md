...
## I. Why the Beginning Is a Problem

Every science begins somewhere. The geometer begins with point and line; the physicist with mass, length, and time; the empiricist with sense-data; the metaphysician with God, substance, or the soul. In each case the beginning is **assumed**. It is taken up from somewhere outside the science — from intuition, from definition, from common conviction, from a previous science — and only then does demonstration begin.
...
This sounds like an impossibility — and that is exactly the point. The opening of the *Logic* will show that this apparent impossibility is the **first dialectical step**: the beginning, taken at its word, is the first contradiction, and from this contradiction the entire system unfolds.

## II. Being

What survives the demand for absolute purity? Only this: that there is *something to be thought at all* — that the beginning **is**. Strip away every quality, every relation, every distinction, every comparison; let nothing be presupposed about it; let it be merely what it is, before any predicate. What remains is **Being** — pure, immediate, indeterminate.
...
But: pure Being, taken with full strictness, is *indistinguishable from Nothing*. Try to think it. There is no quality to attend to, no determination to seize, no point at which the mind can fix itself. The thought of pure Being, when one actually attempts it, finds itself thinking — nothing.

**Nothing**, in turn, is not a particular absence (the absence of *this* or of *that* — those would already be determinate negations). It is pure absence as such, total indeterminacy. And so Nothing, no less than Being, is pure immediacy without quality, content, or distinction.

The two thoughts are *identical in their definition* — both are pure indeterminate immediacy — and yet they are *opposed in their meaning*: one means utter affirmation, the other utter negation. The *Logic* opens with this astounding result: **Being is Nothing, and Nothing is Being** — not by accident of language, not by sophistry, but by the immanent self-examination of each.

This is the first contradiction, and it is not a defect to be patched. It is the very content of the beginning. The beginning, taken purely, is its own opposite.

## IV. Becoming

The truth of this contradiction is not that one of the two terms is correct and the other is mistaken. It is that **each passes over into the other**. Being, taken purely, vanishes into Nothing; Nothing, taken purely, passes over into Being. This restless passing-over of each into the other is itself a determinate thought: it is **Becoming**.

Becoming is the **truth** of Being and of Nothing — truth here meaning not "correct proposition" but the more adequate thought-determination in which the partial and self-contradictory determinations are preserved as moments of a richer whole. In Becoming, Being and Nothing are not abolished; they are retained as its two aspects — *coming-to-be* (passing from Nothing to Being) and *ceasing-to-be* (passing from Being to Nothing).

So in three steps the *Logic* has given us:

- An **immediate** determination (Being).
...
1. **Immediacy.** A determination is taken up purely in itself, without reference to anything else. (Being is just Being; not Being-as-opposed-to-Nothing.)
2. **Self-negation.** When this determination is held fast and thought through, it shows itself, *of itself*, to be inseparable from its opposite. The negation is not brought in from outside; it is what the determination itself becomes when one tries to keep it pure. (Pure Being, attended to, *is* the thought of Nothing.)
3. **Sublation** (*Aufhebung*). The two opposed determinations are recognized as moments of a third, which is the truth of both — annulling their false independence, preserving their content, lifting them into a richer determination. (Becoming holds both as its moments; *Dasein* is the result of their settled unity.)
...
## Summary Diagram of the Step

```
            (immediate)
              Being
                │
                │  is, in its purity, indistinguishable from
                ▼
             Nothing
                │
                │  the truth of their reciprocal passage is
                ▼
            Becoming
                │
                │  whose result, when its movement settles, is
                ▼
